...
export interface LayoutState {
  ...
  layoutModeType: LAYOUT_MODE_TYPES.DARKMODE | LAYOUT_MODE_TYPES.LIGHTMODE ;
  layoutDirectionType:LAYOUT_DIRECTION.RTL| LAYOUT_DIRECTION.LTR  ;
...
export const initialState: LayoutState = {
  ...
  layoutDirectionType: LAYOUT_DIRECTION.RTL,
