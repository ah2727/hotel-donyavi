...
const UiNotification = () => {
    ...
    const greenToast = () => toast.success("Your application was successfully sent", { autoClose: 3000, theme: "colored", icon: false, closeButton: false });
    const warningToast = () => toast.warning("Warning ! Something went wrong try again", { autoClose: 3000, theme: "colored", icon: false, closeButton: false });
    const errorToast = () => toast.error("Error ! An error occurred.", { autoClose: 3000, theme: "colored", icon: false, closeButton: false });
    ...
    const offsetPosition = () => toast.info("Welcome Back ! This is a Toast Notification", { autoClose: 3000, theme: "colored", icon: false});
    const CloseIconDisplay = () => toast.info("Welcome Back ! This is a Toast Notification", { autoClose: 3000, theme: "colored", icon: false});
    const Duration = () => toast.info("Toast Duration 5s", { autoClose: 5000, theme: "colored", icon: false});
